  ...
  return (
    <div className={styles.aboutMe}>
      ...
      <div className={styles.blurb}>
        ...
        <p className={styles.description}>Hi, I’m Codie, a passionate Full Stack Developer with a strong focus on Frontend Development. I take pride in  my experience in building dynamic and responsive websites, ensuring that I deliver user-centered, aesthetically pleasing, and functional web applications.
